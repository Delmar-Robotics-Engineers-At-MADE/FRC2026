...
public class DriveSubsystem extends SubsystemBase {
   ...
   public static final double DriveSpeedDivider = 1;
   ...
   String getPoseRot() {
      return m_odometry.getEstimatedPosition().getRotation().toString();
   }
   ...
   // important to call the version with gyro, since that calculates the offset
   // from gyro to pose
   ...
   public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative) {
      ...
      var swerveModuleStates = DriveConstants.kDriveKinematics.toSwerveModuleStates(
            fieldRelative  ? ChassisSpeeds.fromFieldRelativeSpeeds(xSpeedDelivered, ySpeedDelivered, rotDelivered,
                                 Rotation2d.fromDegrees(m_gyro.getAngle() * (DriveConstants.kGyroReversed ? -1.0 : 1.0)))
